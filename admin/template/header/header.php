...
<head>
  ...
  <!-- Ekko Lightbox -->
  <link rel="stylesheet" href="/spk_pm_unm/assets/plugins/ekko-lightbox/ekko-lightbox.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  <!-- Tempusdominus Bbootstrap 4 -->
  <link rel="stylesheet" href="/spk_pm_unm/assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- DataTables -->
  <link rel="stylesheet" href="/spk_pm_unm/assets/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
  <link rel="stylesheet" href="/spk_pm_unm/assets/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
...
<!-- bootstrap-switch-button -->
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="/spk_pm_unm/assets/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/spk_pm_unm/admin/index.php" class="nav-link">Home</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="/spk_pm_unm/admin/index.php" class="brand-link">
      <img src="/spk_pm_unm/assets/dist/img/logo_unm_bg_white.png" alt="Logo Kabupaten Soppeng" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">SPK PM</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/spk_pm_unm/assets/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="/spk_pm_unm/admin/" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="/spk_pm_unm/admin/mahasiswa/data.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/spk_pm_unm/admin/aspek/data.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/spk_pm_unm/admin/kriteria/data.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Kriteria
              </p>
          ...
          <li class="nav-item">
            <a href="/spk_pm_unm/admin/penilaian/data.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Penilaian
              </p>
          ...
          <li class="nav-item">
            <a href="/spk_pm_unm/admin/pengaturan/data.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Pengaturan
              </p>
          ...
          <li class="nav-item">
            <a href="/spk_pm_unm/admin/hasil-akhir/data.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Hasil Akhir
              </p>
          ...
          <li class="nav-item">
            <a href="/spk_pm_unm/admin/user/data.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Admin
              </p>
          ...
          <li class="nav-item">
            <a class="nav-link"  href="/spk_pm_unm/logout.php?logout=true&for=login_admin" role="button">
