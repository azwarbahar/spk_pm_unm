        ...
        <div class="col-md-10">
          <div class="card card-primary">
            ...
            <div class="form-group">
                ...
                <input type="text" id="no_induk_mahasiswa" name="no_induk_mahasiswa" value="<?= $dta['no_induk_mahasiswa'] ?>" class="form-control">
              </div>

              <div class="form-group">
                <label for="inputName">Nama Lengkap</label>
                <input type="text" id="nama_mahasiswa" name="nama_mahasiswa" value="<?= $dta['nama_mahasiswa'] ?>" class="form-control">
              </div>

              <div class="form-group">
                <label for="inputName">Alamat</label>
                <input type="text" id="alamat_mahasiswa" name="alamat_mahasiswa" value="<?= $dta['alamat_mahasiswa'] ?>" class="form-control">
              </div>
              ...
              <div class="col-4">
                <select class="form-control select2" style="width: 100%;" name="jekel_mahasiswa" id="jekel_mahasiswa">
                  <option selected="selected" value="<?= $dta['jekel_mahasiswa'] ?>"><?= $dta['jekel_mahasiswa'] ?></option>
              ...
              <div class="form-group">
                ...
                <input id="tempat_lahir_mahasiswa" name="tempat_lahir_mahasiswa" value="<?= $dta['tempat_lahir_mahasiswa'] ?>" class="form-control" >
              </div>
              ...
              <div class="col-12">
              <input type="hidden" name="tgl_lahir_mahasiswa" value="<?= $dta['tgl_lahir_mahasiswa'] ?>">
              <input type="hidden" name="id_mahasiswa" value="<?= $dta['id_mahasiswa'] ?>">
              <button type="submit" name="edit_mahasiswa" id="edit_admin" disabled="" class="btn btn-success float-right" style="margin-top: 3% ; margin-left: 2%;">Simpan</button>
